...
void searchAT()
{
    ...
    scanf("%s",src);
    while(temp!=NULL && ((strcmp(temp->name,src)!=0)&&((strcmp(temp->room,src)!=0) && (strcmp(temp->id,src)!=0)

    &&(strcmp(temp->sub,src)!=0))))
    {
        pre=temp;
        temp=temp-> next;
    }
...
//login
   ...
   stu *pre=NULL;
    stu *temp=headS;
 while((temp!=NULL) &&  (strcmp(temp->id,i)!=0))
    {
        pre=temp;
        temp=temp-> next;
    }
...
{
    int o1,o2,o3,o4,o5,o6,o7,o8,o9,o10,o11,o12,o13,o14,o15,o16,o17,o18,o19,o20;//these are options
    char pass[8],password[]= {"n"};
    printf("\t\t\t\tWelcome to our Project\n\t\t==================================================\n\n");
    printf("\tProject  Name: School Management System\n");
    printf("\tProject Team Name:Adios \n");
    printf("\tProject Team Member: \n");
    printf("\t\tNaeem Islam(182)\n");
    printf("\t\tFaminul Aman(189)\n");
   // \n");
